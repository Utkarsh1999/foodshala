                ...
                <form action="./config/function.php" method="post">
                    ...
                    <div class="form-group">
                        <div class="custom-control custom-radio custom-control-inline">
                            <input type="radio" id="ivegradio" name="ivegradio" class="custom-control-input" required>
                            <label class="custom-control-label" for="ivegradio">Veg Food</label>
                        </div>
                        <div class="custom-control custom-radio custom-control-inline">
                            <input type="radio" id="inonvegradio" name="ivegradio" class="custom-control-input" required>
                            <label class="custom-control-label" for="inonvegradio">Non-Veg Food</label>
                        </div>
                    </div>
                    <div class="form-group custom-file mb-2">
                        <input type="file" class="custom-file-input" id="iimage" name="iimage">
